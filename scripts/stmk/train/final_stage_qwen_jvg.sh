...
RUN_NAME="llava-onevision-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-final_stage_jvg" 
...
ACCELERATE_CPU_AFFINITY=1 torchrun --standalone --nproc_per_node=2 --nnodes=1 \
    ...
    --image_folder /storage_nvme/datasets/geniac2.0-multi-modal-datasets/datasets/pair_datasets/Japanese-Visual-Genome-VQA-dataset-jsonl/images \
